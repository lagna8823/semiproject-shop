	                        ...
	                        <div class="row">
	                            <div class="col-lg-6 col-md-6 col-sm-6">
	                                <div class="shop__product__option__left">
	                                    <p>Showing ${beginRow}–${endRow} of ${totalCnt} results</p>
	                                </div>
	                            </div>                           
	                            <div class="col-lg-6 col-md-6 col-sm-6">
										...
										<div>
											<c:if test="${loginEmp != null}">
												<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/goods/addGoods'">
													상품추가
												</button>
											</c:if>
										</div>
