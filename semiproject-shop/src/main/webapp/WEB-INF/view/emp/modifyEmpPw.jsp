				...
				<div class="row justify-content-center">
					<div class="content-wrapper row justify-content-center">
						<div class="col-lg-4 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<h2 class = "font-weight-bold text-center text-primary">emp 비밀번호 변경</h2>
										<div class="row justify-content-center mt-3">
											<div class="col mt-3">
											<form action = "${pageContext.request.contextPath }/emp/modifyEmpPw" method = "post">										
												<!--  EmpNewPw -->
												<div class="form-group">
													<label for="empNewPw">새로운 비밀번호</label>
													<input type = "password" name = "empNewPw" id = "empNewPw"
															class="form-control">											
												</div>
												
												<!--  EmpNewPwCheck -->
												<div class="form-group">
													<label for="empNewPwCheck">새로운 비밀번호 확인</label>
													<input type = "password" name = "empNewPwCheck" id = "empNewPwCheck"
															class="form-control">											
												</div>
